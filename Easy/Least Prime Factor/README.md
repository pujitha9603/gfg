<h2><a href="https://www.geeksforgeeks.org/problems/least-prime-factor5216/1?page=1&category=sieve&difficulty=Easy&sortBy=submissions">Least Prime Factor</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number N, find the least prime factors for all numbers from 1 to N.&nbsp; The least prime factor of an integer X is the smallest prime number that divides it.<br><strong>Note : </strong></span></p>
<ul>
